...
module.exports = {
    method: 'PUT',
    path: '/api/character/skillSection/create',
    handler: (req) => __awaiter(this, void 0, void 0, function* () {
        let err;
        const updated = yield dataManager.AddSkillSection(req.payload, req.pre.user.id).catch(error => {
...
//# sourceMappingURL=addSkillSection.js.map